                ...
                <Col sm={12} md={6} lg={4} className="fullWidthColumn">
                    <Carousel controls={false} indicators={false}>
                        <CarouselItem key={experience.id} >
                            <img src='https://cdn.cnn.com/cnnnext/dam/assets/151030143154-burt-reynolds-smokey-and-the-bandit-full-169.jpg' alt='altTextHere' />
                            <CarouselCaption captionText='captionTextHere' captionHeader='captionHeaderHere' />
                        </CarouselItem>
                    </Carousel>
                </Col>
            </Row>
